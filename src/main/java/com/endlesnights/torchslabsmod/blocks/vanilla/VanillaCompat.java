...
//		pad_lantern = registerBlock(() -> new BlockPadLantern(Block.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.LANTERN).func_235838_a_((p_235454_0_) -> {return 15; }).notSolid(), 'l'), "pad_lantern");
		...
		pad_lantern = registerBlock("pad_lantern", () -> new BlockPadLantern((BlockBehaviour.Properties.copy(Blocks.LANTERN).instabreak().sound(SoundType.LANTERN).noOcclusion().lightLevel((p_50878_) -> { return 15; })), 'l'));
		pad_soul_lantern = registerBlock("pad_soul_lantern", () -> new BlockPadLantern((BlockBehaviour.Properties.copy(Blocks.LANTERN).instabreak().sound(SoundType.LANTERN).noOcclusion().lightLevel((p_50878_) -> { return 10; })), 's'));
